...
(function (global) {
  ...
  var translations = {
    ar: {
      ...
      "clients.tag": "عملاؤنا",
      "clients.title": "شركات وثقت بنا",
      "clients.desc": "نفخر بشراكتنا مع نخبة من الشركات الرائدة في العراق عبر قطاعات متنوعة — من التجارة والصناعة الغذائية إلى الرعاية الصحية والاتصالات.",
      "clients.comienzo": "Comienzo",
      "clients.alsalail": "شركة السلايل للتجارة العامة والخدمات الغذائية",
      "clients.rawabi": "مجموعة الروابي",
      "clients.sumer": "Sumer Holding",
      "clients.nay": "شبكة ناي",
      "clients.unimedica": "الشركة الطبية المتحدة",
      "clients.qimatalhikma": "شركة قمة الحكمة للمحاماة والاستشارات القانونية",
      "clients.zarqa": "شركة زرقاء اليمامة",
      "clients.alkahraman": "الكهرمان للذهب والمجوهرات",
      "clients.alriyadh": "الرياض",
      "clients.nabaaalnumair": "شركة نبع النمير",
      "clients.cinnabon": "Cinnabon",
      "clients.friedchicken": "فرايد تشكن",
      ...
      "careers.modal.experience": "الخبرات المطلوبة",
      "careers.modal.company": "الشركة",
      "careers.modal.posted": "تاريخ النشر",
      "careers.copyLink": "نسخ الرابط",
      "careers.copied": "تم نسخ الرابط ✓",
    ...
    en: {
      ...
      "clients.desc": "We are proud to partner with leading companies across Iraq in a wide range of sectors \u2014 from trade and food services to healthcare and telecommunications.",
      "clients.comienzo": "Comienzo",
      "clients.alsalail": "Al Salail General Trading & Food Services",
      "clients.rawabi": "Rawabi Group",
      "clients.sumer": "Sumer Holding",
      "clients.nay": "Nay Network",
      "clients.unimedica": "Unimedica",
      "clients.qimatalhikma": "Qimat Al Hikma Law Firm & Legal Consultations",
      "clients.zarqa": "Zarqa Al Yamama Company",
      "clients.alkahraman": "Alkahraman Gold & Jewelry",
      "clients.alriyadh": "Al Riyadh",
      "clients.nabaaalnumair": "Nabaa Al Numair Company",
      "clients.cinnabon": "Cinnabon",
      "clients.friedchicken": "Fried Chicken",
      ...
      "careers.modal.experience": "Required experience",
      "careers.modal.company": "Company",
      "careers.modal.posted": "Posted on",
      "careers.copyLink": "Copy link",
      "careers.copied": "Link copied ✓",
